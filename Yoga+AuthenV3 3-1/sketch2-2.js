...
let posesArray = ['Chair', 'Warrior I','Warrior II'];
...
function setup() {
  ...
  imgArray[0].src = 'vinyasa/chair-4.jpeg';
  imgArray[1] = new Image();
  imgArray[1].src = 'vinyasa/warrior1-5.jpeg';
  imgArray[2] = new Image();
  imgArray[2].src = 'vinyasa/warrior2-6.jpeg';
...
function draw() {
  ...
  if (poseLabel == 'c'){
    fill(245,189,224);
    text("Warrior II correct!",width/2,height/7);
  }
}