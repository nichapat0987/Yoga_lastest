...
let brain;
let targeLabel;
let posesTarget = ['m','t','w']
let posesArray = ['Mountain', 'Tree', 'WarriorII'];
...
function setup() {
  ...
  imgArray[0].src = 'pic/mountain.jpeg';
  imgArray[1] = new Image();
  imgArray[1].src = 'pic/tree.jpeg';
  imgArray[2] = new Image();
  imgArray[2].src = 'pic/warriorII.jpeg';
...
function draw() {
  ...
  if (poseLabel == 'm'){
    fill(81,159,96);
    text("mountain pose correct!",width/2,height/7);
  }
  if (poseLabel == 't'){
    fill(86,149,232);
    text("tree pose correct!",width/2,height/7);
  }
  if (poseLabel == 'w'){
    fill(245,189,224);
    text("warriorII pose correct!",width/2,height/7);
  }
}